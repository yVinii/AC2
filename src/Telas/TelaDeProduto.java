...
public class TelaDeProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CmbTratamentos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vacina", "Higiene", "Cirurgia", "Consulta", "Internação" }));
        ...
        CmbEspecie.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cachorro", "Gato", "Hamster", "Pássaro", "Peixe", "Cavalo", "Coelho" }));
        ...
        CmbTratamentos1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vacina", "Higiene", "Cirurgia", "Consulta", "Internação" }));
        ...
        CmbEspecie1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cachorro", "Gato", "Hamster", "Pássaro", "Peixe", "Cavalo", "Coelho" }));
    ...
    private void butAtualizar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_butAtualizar1MouseClicked
        ...
        if(status){JOptionPane.showMessageDialog(null, "Atualização realizada com sucesso"); limparFinalizar();
        }else{ JOptionPane.showMessageDialog(null, "Houve um erro na atualização, tente novamente");
        }
        } catch (Exception e) {
            e.getMessage();
